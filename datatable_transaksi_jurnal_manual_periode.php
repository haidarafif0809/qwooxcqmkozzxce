...
$pilih_akses_akuntansi = $db->query("SELECT transaksi_jurnal_manual_hapus, transaksi_jurnal_manual_edit FROM otoritas_laporan WHERE id_otoritas = '$_SESSION[otoritas_id]'");
...
$sql = " SELECT *  ";
$sql.= " FROM jurnal_trans WHERE jenis_transaksi = 'Jurnal Manual' AND DATE(waktu_jurnal) >= '$dari_tanggal' AND DATE(waktu_jurnal) <= '$sampai_tanggal' GROUP BY no_faktur ";
...
$sql = " SELECT * ";
$sql.= " FROM jurnal_trans WHERE 1=1 AND  jenis_transaksi = 'Jurnal Manual' AND DATE(waktu_jurnal) >= '$dari_tanggal' AND DATE(waktu_jurnal) <= '$sampai_tanggal'  ";
