...
$querycet = $db->query("SELECT km.id, km.no_faktur, km.keterangan, km.ke_akun, km.dari_akun, km.jumlah, km.tanggal, km.jam, km.user, da.nama_daftar_akun FROM detail_kas_keluar km INNER JOIN daftar_akun da ON km.ke_akun = da.kode_daftar_akun WHERE no_faktur = '$no_faktur'");
    

$queryedit = $db->query("SELECT id,user_edit,jumlah,user_edit,waktu_edit,no_faktur FROM kas_keluar WHERE no_faktur = '$no_faktur'");
...
<div style="padding-right: 5%; padding-left: 5%; padding-top: 5%; padding-bottom: 5%;" >
                 ...
                 <h3> <b><center>DATA KAS KELUAR </center> </b></h3>
    <div class="row"><!--row1-->
        <div class="col-sm-2">
