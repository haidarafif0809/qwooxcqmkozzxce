<?php session_start();
    ...
    $query = $db->query("DELETE FROM tbs_penjualan WHERE session_id = '$session_id' AND lab = 'Laboratorium' ");
    ...
    if ($query == TRUE)
    {
    echo '<META HTTP-EQUIV="Refresh" Content="0; URL=form_penjualan_lab.php">';
    }
    else
    {
        echo "failed";
