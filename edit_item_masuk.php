                          ...
                          <div class="row">
                              ...
                              <div class="col-sm-3">
                                <div class="form-group">
                                  <input type="text" class="form-control" name="kode_barang" id="kode_barang" placeholder="Ketikan Kode Produk">
   ...
   <strong>Berhasil!</strong> Data Berhasil Di Edit
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                              ...
                              $perintah = $db->query("SELECT tim.id,tim.no_faktur,tim.kode_barang,tim.nama_barang,tim.jumlah,tim.harga,tim.subtotal,s.nama FROM tbs_item_masuk tim INNER JOIN satuan s ON tim.satuan = s.id WHERE tim.no_faktur = '$no_faktur'");
                              ...
                              $("#total_item_masuk"). val(tandaPemisahTitik(data));
                              });
