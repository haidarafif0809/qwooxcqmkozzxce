...
if ($lihat['input_rawat_jalan'] > 0){
        echo '<li><a href="form_input_data_kasir.php" class="waves-effect"> Rawat Jalan</a></li>';
       }

if ($lihat['input_rawat_inap'] > 0){
        echo '<li><a href="form_input_data_ranap.php" class="waves-effect"> Rawat Inap</a></li>';
    }

if ($lihat['input_ugd'] > 0){
        echo '<li><a href="form_input_data_ugd.php" class="waves-effect"> UGD</a></li>';
    }
...
if ($lihat['laporan_laboratorium_lihat'] > 0){
 ...
 if ($lihat['laporan_kunjungan_ugd'] > 0){
    ...
    echo '<li><a href="lap_limit_stok_produk.php" class="waves-effect">Lap. Limit Stok Produk</a></li>';
