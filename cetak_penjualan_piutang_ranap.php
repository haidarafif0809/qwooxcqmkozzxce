...
<div class="container">
 ...
 <table>
  <tbody>
       ...
       <tr><td width="50%"><font class="satu"> Tanggal Masuk</td> <td> :&nbsp;&nbsp;</td> <td><?php echo tanggal($data0['tanggal_masuk']);?></font> </td></tr> 
       <tr><td width="50%"><font class="satu"> Tanggal Keluar</td> <td> :&nbsp;&nbsp;</td> <td><?php echo tanggal($data0['tanggal']);?></font> </td></tr> 
