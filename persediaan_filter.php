...
th {
    ...
    <li class="nav-item"><a class="nav-link active" class="nav-link" href='persediaan_filter.php?kategori=semua&tipe=barang'>Filter Limit Stok</a></li>
...
<li class="nav-item"><a class="nav-link" href='persediaan_filter_over.php?kategori=semua&tipe=barang'>Filter Over Stok</a></li>
    ...
    <li class="nav-item"><a class="nav-link active" class="nav-link" href='persediaan_filter.php?kategori=semua&tipe=barang_jasa'>Filter Limit Stok</a></li>
...
<!--Form Filter-->
 ...
 <div class="col-sm-2">
     <div class="form-group">
     <input type="text" placeholder="Jumlah Limit Stok" name="filter_limit" id="filter_limit" class="form-control" autocomplete="off" required="">
     </div>
 </div>

<div class="col-sm-2">
    <button type="submit" name="submit_filter_limit" id="submit_filter_limit" class="btn btn-info">Cari</button>
</div>
<div class="col-sm-8">
</div>
</div> <!-- END ROW FILTER-->
</form>
<!-- END FORM FILTER DATA-->
...
<!-- UNTUK FILTER LIMIT STOK -->
<script type="text/javascript">
        $("#submit_filter_limit").click(function(){
        
        var filter_limit = $("#filter_limit").val();        
        
        $.post("show_filter_persediaan.php", {filter_limit:filter_limit},function(info){
