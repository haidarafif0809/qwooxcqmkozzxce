...
$take_rm = $db->query("SELECT no_rm,no_reg,nama_pasien,jenis_kelamin,umur_pasien,alamat_pasien,penjamin,hp_pasien,tanggal FROM registrasi WHERE jenis_pasien = 'Rawat Jalan' AND tanggal >= '$dari_tanggal' AND tanggal <= '$sampai_tanggal'");
