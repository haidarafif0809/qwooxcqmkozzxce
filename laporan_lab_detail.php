...
<h3><b>LAPORAN LABORATORIUM DETAIL</b></h3><hr>
...
<table>
 ...
 <a href="cetak_lab_detail.php" target="blank" id="cetak_lap" class="btn btn-info"><i class="fa fa-print" > </i> Cetak </a>

  <a href="download_lab_detail.php" target="blank" id="download" class="btn btn-success"><i class="fa fa-download" > </i> Download </a>
</span>
</div> <!--/ container-->
...
$("#submit").click(function(){
		...
		if (dari_tanggal == '') {
		  ...
		  var dataTable = $('#tableuser').DataTable( {
              ...
              "emptyTable":   "My Custom Message On Empty Table"
                ...
                "ajax":{
                  url :"show_lab_detail.php", // json datasource
                   "data": function ( d ) {
    ...
    $("#cetak").show();
    $("#cetak_lap").attr("href", "cetak_lab_detail.php?dari_tanggal="+dari_tanggal+"&sampai_tanggal="+sampai_tanggal+"");

     $("#download").attr("href", "download_lab_detail.php?dari_tanggal="+dari_tanggal+"&sampai_tanggal="+sampai_tanggal+"");
	}
