...
$no_faktur_jurnal = $ambil_no_jurnal['no_faktur_jurnal'];
     ...
     $insert_no_faktur_jurnal = $db->query("INSERT INTO history_input_tbs_jurnal (no_faktur_jurnal, session_id, kode_akun_jurnal, nama_akun_jurnal, debit, kredit, keterangan, user_input) SELECT '$no_faktur_jurnal', session_id, kode_akun_jurnal, nama_akun_jurnal, debit, kredit, keterangan, '$user' FROM tbs_jurnal WHERE session_id = '$session_jurnal_manual'";
