...
$sql = "SELECT id,no_rm,no_reg,nama_pasien,jenis_kelamin,umur_pasien,jenis_pasien,alamat_pasien,penjamin,hp_pasien,tanggal,dokter ";
$sql.=" FROM registrasi WHERE (no_rm = '$no_rm' AND jenis_pasien = 'Rawat Jalan') OR (no_rm = '$no_rm' AND jenis_pasien = 'Rawat Inap') OR (no_rm = '$no_rm' AND jenis_pasien = 'UGD') ";
