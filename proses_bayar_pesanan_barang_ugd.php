...
//POTONGAN
    ...
    // hubungkan "data" dengan prepared statements
              $stmt->bind_param("sssisisiiisisssiss",
                $petugas_farmasi, $petugas_paramedik, $petugas_lain, $biaya_adm, $kode_gudang, $total, $jam, $potongan, $tax, $kredit, $cara_bayar, $pembayaran, $ppn_input, $keterangan, $nama_petugas, $kredit, $nomor_faktur, $no_reg );
