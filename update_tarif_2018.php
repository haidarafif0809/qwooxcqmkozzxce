...
while ($data = mysqli_fetch_array($barang)) {
    ...
    $update_produk = "UPDATE barang SET harga_jual = '$data[harga_jual_1]', harga_jual2 = '$data[harga_jual_2]',harga_jual4 = '$data[harga_jual_4]',harga_jual_inap = '$data[harga_jual_1]', harga_jual_inap2 = '$data[harga_jual_2]',harga_jual_inap4 = '$data[harga_jual_4]' WHERE nama_barang = '$data[dari_update]' ";
