...
$take_rm = $db->query("SELECT id,no_rm,no_reg,nama_pasien,jenis_kelamin,umur_pasien,alamat_pasien,penjamin,hp_pasien,tanggal FROM registrasi WHERE no_rm = '$no_rm' AND jenis_pasien = 'Rawat Jalan' AND tanggal >= '$dari_tanggal' AND tanggal <= '$sampai_tanggal'");
...
<a href='export_excel_ex_rj.php?no_rm=<?php echo $no_rm; ?>&dari_tanggal=<?php echo $dari_tanggal; ?>&sampai_tanggal=<?php echo $sampai_tanggal; ?>' type='submit' class='btn btn-warning btn-lg'>Download Excel</a>
