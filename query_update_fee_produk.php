...
$select = $db->query("SELECT harga_jual, kode_barang, nama_barang FROM barang WHERE berkaitan_dgn_stok = 'Jasa' ");
...
$jumlah_uang = $data['jumlah_prosentase'] * $amb['harga_jual'] / 100;
$jumlah_prosentase = 0;
