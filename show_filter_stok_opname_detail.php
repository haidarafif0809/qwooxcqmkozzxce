...
?>
<br>
<button type="submit" name="submit" id="filter_1" class="btn btn-primary" ></i> Filter Faktur </button>
<button type="submit" name="submit" id="filter_2" class="btn btn-primary" ></i> Filter Detail </button>
