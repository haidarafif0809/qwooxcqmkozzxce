...
$select = $db->query("SELECT * FROM hasil_lab WHERE no_reg = '$no_reg' AND status = 'Selesai' AND lab_ke_berapa = '$no_periksa' AND status_lab IS NULL");
...
<div class="container">
  ...
  <tbody> 
      ...
      <tr><td  width="50%">Analis &nbsp;&nbsp;&nbsp;&nbsp;:&nbsp; <?php echo $analis;?> </td></tr>
       <tr><td  width="50%">Pemeriksaan Ke &nbsp;&nbsp;&nbsp;&nbsp;:&nbsp; <?php echo $no_periksa;?> </td></tr>
  </tbody>
  </table>       
...
<table id="tableuser" class="table table-bordered table-sm">
 ...
 $show = $db->query("SELECT * FROM hasil_lab WHERE no_reg = '$no_reg' AND status = 'Selesai' AND status_lab IS NULL AND id_sub_header != '0' GROUP BY id_sub_header ");
...
if($face_drop >= 1)
{
    ...
    $show_one = $db->query("SELECT * FROM hasil_lab WHERE no_reg = '$no_reg' AND status = 'Selesai' AND lab_ke_berapa = '$no_periksa' AND status_lab IS NULL AND id_sub_header = '$id_get' ");
...
//start untuk yang sendirian / yang tidak ber HEADER/INDUX
       $show_two = $db->query("SELECT * FROM hasil_lab WHERE no_reg = '$no_reg' AND status = 'Selesai' AND lab_ke_berapa = '$no_periksa' AND status_lab IS NULL AND id_sub_header = 0");
            //menyimpan data sementara yang ada pada $perintah
