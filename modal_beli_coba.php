...
<?php
        ...
        $perintah = $db->query("SELECT b.id, b.kode_barang, b.nama_barang, b.harga_beli, b.satuan, b.kategori, b.suplier, b.over_stok, b.stok_barang, sk.harga_pokok FROM barang b LEFT JOIN satuan_konversi sk ON b.id = sk.id_produk WHERE b.berkaitan_dgn_stok = 'Barang' || b.berkaitan_dgn_stok = '' GROUP BY b.kode_barang ");
