    ...
    while ($data_pemeriksaan_radiologi = mysqli_fetch_array($query_pemeriksaan_radiologi))
      {
        ...
        (no_reg,kode_jasa,nama_jasa,harga,dokter,analis,tanggal,jam,kontras,status_pilih_radiologi) VALUES ('$no_reg',
        '$data_pemeriksaan_radiologi[kode_pemeriksaan]','$data_pemeriksaan_radiologi[nama_pemeriksaan]',
        '$data_pemeriksaan_radiologi[harga_1]','$dokter_pengirim','$petugas_radiologi','$tanggal_sekarang',
        '$jam_sekarang','$data_pemeriksaan_radiologi[kontras]','Pilih Semua')");

			$insert_tbs = "INSERT INTO tbs_penjualan_radiologi (session_id, kode_barang, nama_barang, jumlah_barang, harga, subtotal, tipe_barang, tanggal, jam, no_reg, kontras, dokter_pengirim, dokter_pelaksana, radiologi, status_pilih) VALUES ('$session_id', '$data_pemeriksaan_radiologi[kode_pemeriksaan]',
			'$data_pemeriksaan_radiologi[nama_pemeriksaan]', '$jumlah_barang', '$data_pemeriksaan_radiologi[harga_1]', 
			'$subtotal', '$tipe_barang', '$tanggal_sekarang', '$jam_sekarang', '$no_reg',
			'$data_pemeriksaan_radiologi[kontras]', '$dokter_pengirim', '$petugas_radiologi', 'Radiologi', 'Pilih Semua')";
