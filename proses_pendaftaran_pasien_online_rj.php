...
//DATA YANG DIBUTUHKAN DI PROSES PENDAFTARAN PASIEN BARU
	...
	echo $no_rm = $query_pelanggan['kode_pelanggan'] + 1;
...
//INSERT DATA PASIEN BARU
	...
	$query_insert_pasien->bind_param("ssssssssssssssssssssssssss",$alergi,$no_kk,$nama_kk,$no_rm,$nama_lengkap,$tempat_lahir,$tanggal_lahir,$umur,$alamat_sekarang,$alamat_ktp,$no_telepon,$no_ktp,$nama_suamiortu,$pekerjaan_pasien,$nama_penanggungjawab,$hubungan_dengan_pasien,$alamat_penanggung,$no_hp_penanggung,$jenis_kelamin,$pendidikan_terakhir,$status_kawin,$agama,$penjamin,$gol_darah,$tanggal_sekarang,$no_rm_lama);
