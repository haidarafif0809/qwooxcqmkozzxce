...
$tenant_detail = stringdoang($_POST['tenant_detail']);
...
<a href='export_kategori_detail.php?tenant_detail=<?php echo $tenant_detail; ?>&dari_tanggal=<?php echo $dari_tanggal; ?>&sampai_tanggal=<?php echo $sampai_tanggal; ?>' type='submit' class='btn btn-warning btn-lg'>Download Excel</a>
