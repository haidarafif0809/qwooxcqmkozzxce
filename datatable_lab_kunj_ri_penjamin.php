...
$sql = "SELECT r.id,r.no_rm,r.no_reg,r.nama_pasien,r.jenis_kelamin,r.umur_pasien,r.alamat_pasien,r.penjamin,r.hp_pasien,r.tanggal,r.bed,r.group_bed,r.menginap,p.total ";
$sql.=" FROM registrasi r INNER JOIN penjualan p ON r.no_reg = p.no_reg  WHERE r.penjamin = '$penjamin' AND  r.tanggal >= '$dari_tanggal' AND r.tanggal <= '$sampai_tanggal' AND r.jenis_pasien = 'Rawat Inap' ";
...
$sql.=" FROM registrasi r INNER JOIN penjualan p ON r.no_reg = p.no_reg  WHERE 1=1 AND r.penjamin = '$penjamin' AND  r.tanggal >= '$dari_tanggal' AND r.tanggal <= '$sampai_tanggal' AND r.jenis_pasien = 'Rawat Inap' ";
...
$query01 = $db->query("SELECT SUM(p.total) AS total_penjualan FROM penjualan p INNER JOIN registrasi r ON p.no_reg = r.no_reg WHERE r.jenis_pasien = 'Rawat Inap' AND p.penjamin = '$penjamin' AND p.tanggal >= '$dari_tanggal' AND p.tanggal <= '$sampai_tanggal'");
