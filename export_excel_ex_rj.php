...
header("Content-Disposition: attachment; filename=data_kunjungan_pasien_rj_berdasarkan_rm_dan_tanggal.xls");
...
$take_rm = $db->query("SELECT no_rm,no_reg,nama_pasien,jenis_kelamin,umur_pasien,alamat_pasien,penjamin,hp_pasien,tanggal FROM registrasi WHERE no_rm = '$no_rm' AND jenis_pasien = 'Rawat Jalan' AND tanggal >= '$dari_tanggal' AND tanggal <= '$sampai_tanggal'");
...
<b>
<center>
Data Kunjungan Pasien Rawat Jalan No RM <?php echo $no_rm; ?> Tanggal <?php echo $dari_tanggal; ?> s/d <?php echo $sampai_tanggal; ?>
</center>
</b>
</h3>
