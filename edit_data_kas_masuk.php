...
$query = $db->query("SELECT * FROM kas_masuk  WHERE no_faktur = '$no_faktur' ");
...
<div class="row">
  <div class="form-group col-sm-6" id="col_sm_6">
          <b><label>Total Akhir </label></b><br>
...
$.post("proses_edit_kas_masuk.php", {no_faktur:no_faktur, keterangan:keterangan,ke_akun:ke_akun,jumlah:jumlah,tanggal:tanggal,jam:jam}, function(info) {
