...
// START script untuk pilih kode barang menggunakan chosen     
  $(document).ready(function(){
    ...
    $(document).on('change','#kode_barang',function(){
      ...
      $.post('cek_kode_barang_transfer_stok.php',{kode_barang:kode_barang}, function(data){
        if (data > 0) {
              ...
              $.post('ambil_jumlah_transfer_stok.php',{kode_barang:kode_barang}, function(data){
                if (data == "") {
                data = 0;
                }
    ...
    $(document).on('change','#barang_tujuan',function(){
      ...
      if (barang_tujuan == kode_barang) {
        alert("Tujuan barang tidak boleh sama dengan asal barang, silahkan pilih barang lain!");
          ...
          $.post("cek_barang_transfer_stok.php",{kode_barang:kode_barang,barang_tujuan:barang_tujuan},function(data){
...
var keterangan = $("#keterangan").val();
    ...
    $.getJSON("cek_status_transfer_stok.php", function(result){//$.getJSON("cek_status_stok_penjualan_inap.php
...
$.get("cek_total_transfer.php",function(data){
...
$(document).ready(function(){
  $("#batal").click(function(){
    ...
    if (pesan_alert == true) {
        ...
        $.get("batal_tbs_transfer_stok.php",function(data){
      var tabel_tbs_transfer_stok = $('#tabel_tbs_transfer_stok').DataTable();
          tabel_tbs_transfer_stok.draw();
