...
<!-- AKHIR MODAL untuk tambah obat obatan -->
 ...
 <div class="container"> 
 <h3>INPUT OBAT OBATAN UGD</h3><hr>
...
<ul class="nav nav-tabs md-pills pills-ins" role="tablist">
  ...
  <li class="nav-item"><a class="nav-link active" href="obat_ugd.php?reg=<?php echo $no_reg; ?>&tgl=<?php echo $tgl;?>&id=<?php echo $id;?>&jam=<?php echo $jam;?>">Obat-Obatan</a></li>
