...
$take_rm = $db->query("SELECT no_rm,no_reg,nama_pasien,jenis_kelamin,umur_pasien,alamat_pasien,penjamin,hp_pasien,tanggal FROM registrasi WHERE jenis_pasien = 'Rawat Inap' AND tanggal >= '$dari_tanggal' AND tanggal <= '$sampai_tanggal'");
...
<b>
<center>
Data Kunjungan Pasien Rawat Inap Tanggal <?php echo $dari_tanggal; ?> s/d <?php echo $sampai_tanggal; ?>
</center>
</b>
</h3>
