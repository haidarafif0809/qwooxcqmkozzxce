...
$pilih_penjualan_tunai = $db->query("SELECT ppn, biaya_admin, user, tanggal, jam, cara_bayar, potongan, status, kredit, total, no_faktur, no_reg, kode_pelanggan FROM penjualan WHERE tanggal = '2016-01-16' AND jam  >= '14:00:00' ");
