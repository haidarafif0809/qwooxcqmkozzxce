...
$query = $db->query("SELECT nama_suplier,tanggal FROM pembayaran_piutang WHERE no_faktur_pembayaran = '$nomor_faktur_pembayaran'");
...
<button type="button" class="btn btn-info" id="cari_produk_penjualan" data-toggle="modal" data-target="#myModal"> <i class='fa fa-search'> </i> Cari (F1)</button>
<br><br>
<!-- Tampilan Modal -->
...
<div class="form-group">
         ...
         <b> <input type="text" style="font-size:40px" name="total_bayar" id="totalbayar" placeholder="Total Bayar" class="form-control" readonly="" required=""></b>
          </div>
...
<div class="alert alert-success" id="alert_berhasil" style="display:none">
  ...
  <input type="hidden" name="user_masuk" value="  
<?php echo $_SESSION['user_name']; ?>" id="user_masuk" class="form-control" readonly="" required="">
...
//menyembunyikan notif berhasil
    ...
    /* Act on the event */
      ...
      $.post("modal_edit_piutang_baru.php", {no_faktur_pembayaran:no_faktur_pembayaran,kode_pelanggan:kode_pelanggan}, function(info) {
