  ...
  $harga_jasa = $data_nama_jasa['harga_1'];
   ...
   //INSERT TBS PENJUALAN
    $query_insert_tbs_penjualan = $db->query("INSERT INTO tbs_penjualan 
      (no_reg,kode_barang,nama_barang,harga,subtotal,lab_ke_berapa,tanggal,jam,jumlah_barang, tipe_barang,lab,status_lab,dokter,analis) VALUES ('$no_reg','$kode_jasa_lab',
      '$nama_jasa','$harga_jasa','$harga_jasa','$pemeriksaan_keberapa','$tanggal','$jam','1','jasa',
