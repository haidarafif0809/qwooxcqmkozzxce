...
$sql = "SELECT id,no_reg,no_rm,penjamin,nama_pasien,jenis_kelamin,umur_pasien,hp_pasien,keterangan,dokter_jaga,pengantar_pasien,nama_pengantar,hp_pengantar,tanggal,alamat_pengantar,hubungan_dengan_pasien,status ";
...
$query=mysqli_query($conn, $sql) or die("datatable_registrasi_ugd_belum_selesai.php: get employees");
