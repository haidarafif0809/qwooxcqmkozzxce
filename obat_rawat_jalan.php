...
<!-- AKHIR MODAL untuk tambah obat obatan -->
 ...
 <div class="container"> 
 <h3>INPUT OBAT OBATAN R.JALAN</h3><hr>
...
<ul class="nav nav-tabs md-pills pills-ins" role="tablist">
      <li class="nav-item"><a class="nav-link " href="rekam_medik_raja.php"> Pencarian Rekam Medik </a></li>
        <li class="nav-item"><a class="nav-link" href="input_rekammedik_raja.php?no_reg=<?php echo $no_reg;?>&tgl=<?php echo $tgl;?>&jam=<?php echo $jam;?>" >Data Pemeriksaan</a></li>
         <li class="nav-item"><a class="nav-link active" href="obat_rawat_jalan.php?reg=<?php echo $no_reg; ?>&tgl=<?php echo $tgl;?>&jam=<?php echo $jam;?>" >Obat-Obatan</a></li>
          <li class="nav-item"><a class="nav-link" href="tindakan_rawat_jalan.php?reg=<?php echo $no_reg; ?>&tgl=<?php echo $tgl;?>&jam=<?php echo $jam;?>">Tindakan</a></li>
</ul>
...
<div class="col-sm-2">
 ...
 <label for="penjamin">Dokter Jaga:</label><br>
     <input style="height: 15px;" type="text" class="form-control" id="dokter" name="dokter" value="<?php echo $data1['dokter'];?>" readonly="" >
          <input style="height: 15px;" type="hidden" class="form-control" id="no_rm" name="no_rm" value="<?php echo $data1['no_rm'];?>" readonly="" >
</div>
</div>
...
if ($status_bayar == 'Lunas' OR $status_bayar == 'Piutang' OR $status_bayar == 'Simpan Sementara'):?> 
...
<button type="button" id="cari_produk" class="btn btn-danger" data-target="#myModal2" data-toggle="modal"><i class="fa fa-search"></i> Cari (F1)</button>
<br>
<br>
...
<form class="form" role="form" id="formnya" method="POST">
 <div class="col-sm-4">
  <div class="form-group">  
    <select style="height: 20px;" type="text" class="form-control chosen" accesskey="q" id="kode_produk" autocomplete="off" style="width:700px" name="kode_produk">
...
if ($asa > 0)
...
else
      {
        ...
        $query5 = $db->query("SELECT id,kode_barang,no_reg,nama_barang,jumlah_barang,dosis,jam,tanggal FROM tbs_penjualan WHERE no_reg ='$no_reg' AND tipe_barang = 'Obat Obatan' ORDER BY id DESC");
      ...
      $("#submit_produk").click(function() {
       ...
       $("#dosis").focus();
        ...
        $("#jumlah_produk").focus();
          ...
          $.post("proses_tambah_obat_rawat_jalan.php",{session_id:session_id,no_rm:no_rm,dokter:dokter,dosis:dosis,no_reg:no_reg,tipe:tipe,kode:kode,nama:nama,jumlah:jumlah,stok:stok,sisa:sisa,no_faktur:no_faktur,penjamin:penjamin
