...
{
	$input = $db->query("INSERT INTO hasil_lab (id_pemeriksaan, nama_pemeriksaan, hasil_pemeriksaan, nilai_normal_lk, nilai_normal_pr, status_abnormal, status_pasien, status, no_rm, no_reg, nama_pasien,tanggal,jam) VALUES ('$out[id_pemeriksaan]',
		'$out[nama_pemeriksaan]','$out[hasil_pemeriksaan]','$out[nilai_normal_lk]','$out[nilai_normal_pr]',
		'$out[status_abnormal]','$jenis_penjualan','Selesai','$no_rm','$no_reg','$nama','$tanggal','$jam')");
