...
$query2 = $db->query("SELECT * FROM detail_item_masuk WHERE no_faktur = '$no_faktur' ");

$query3 = $db->query("SELECT SUM(subtotal) AS tot FROM detail_item_masuk WHERE no_faktur = '$no_faktur'");
