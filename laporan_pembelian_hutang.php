   ...
   $(document).ready(function() {
     ...
     $('#tableuser').DataTable().destroy();
        ...
        "emptyTable":     "My Custom Message On Empty Table"
          ...
          "ajax":{
            url :"proses_lap_pembelian_hutang_periode.php", // json datasource
             "data": function ( d ) {
...
<!--END SCRIP PROSES PERIODE-->

<!--START SCRIP PROSES PERTANGGALNYA-->
<script type="text/javascript" language="javascript" >
   $(document).ready(function() {
...
<!--END SCRIP PROSES PERTANGGALNYA-->
