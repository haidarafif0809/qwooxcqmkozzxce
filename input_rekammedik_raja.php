        ...
        <div class="form-group">
            <div class="row">
             	...
             	<div class="col-sm-3">
        	  	...
        	  	<div class="col-sm-9">
  <input style="height: 20px;" type="text" class="form-control" id="dokter" name="dokter" value="<?php echo $dokter; ?>" readonly="" > 
              </div>
            </div>
        </div><!-- akhir row input -->
         ...
         <div class="form-group">
            <div class="row">
              ...
              <div class="col-sm-9">
                <input style="height: 20px;" type="text" class="form-control" id="perawat" name="perawat" value="<?php echo $out['nama']; ?>" readonly="" > 
             </div>
     ...
     <div class="form-group">
        <div class="row">
          ...
          <div class="col-sm-9">
            <input style="height: 20px;" type="text" class="form-control" id="apoteker" name="apoteker" value="<?php echo $out1['nama']; ?>" readonly="" > 
          </div>
