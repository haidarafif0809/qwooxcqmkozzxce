...
$query->execute();
    ...
    $query9 = $db->query("SELECT * FROM tbs_fee_produk WHERE kode_produk = '$kode_barang' AND no_faktur = '$nomor' ");
...
$ff = mysqli_fetch_array($select_fee);
   ...
   $nm_pet = $cek9['nama_petugas'];
        ...
        if ($prosentase != 0)
            ...
            $query1 = $db->query("UPDATE tbs_fee_produk SET jumlah_fee = '$fee_prosentase_produk' WHERE nama_petugas = '$nm_pet' AND kode_produk = '$kode_barang' AND no_faktur = '$nomor' ");
   ...
   elseif ($nominal != 0)       
            ...
            $query01 = $db->query("UPDATE tbs_fee_produk SET jumlah_fee = '$fee_nominal_produk' WHERE nama_petugas = '$nm_pet' AND kode_produk = '$kode_barang' AND no_faktur = '$nomor'");
