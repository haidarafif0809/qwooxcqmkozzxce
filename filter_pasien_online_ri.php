...
$query_setting_registrasi_pasien = $db->query("SELECT url_cari_pasien FROM setting_registrasi_pasien WHERE id = '3' ");
...
$alamat = urlencode(stringdoang($_POST['alamat']));

$data_url = ''.$url.'?search_value='.$search_value.'&start='.$start.'&length='.$length.'&draw='.$draw.'&cari='.$cari.'&alamat='.$alamat.'';
