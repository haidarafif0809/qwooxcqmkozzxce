...
$tanggal = date('Y-m-d');
$query = $db->query("SELECT no_faktur,total,tanggal,jam,potongan,tax FROM penjualan 	");
...
echo "<tr><td>".$data['no_faktur']."</td><td>".$data['tax']."</td><td>".$data['potongan']."</td><td>".$data['total']."</td><td>".$total_asli."</td><td>".$v_detail['subtotal']."</td></tr>";
