...
if ($data_row > 0) {
    ...
    $total_radiologi = $data_radiologi['subtotal_radiologi'];
    ...
    $query_radiologi = $db->query("SELECT SUM(subtotal) AS subtotal_radiologi FROM detail_penjualan WHERE no_reg = '$no_reg' AND tipe_produk = 'Jasa' AND radiologi = 'Radiologi' ");
...
===================<br>
 ...
 <tbody>
      ...
      <tr><td width="50%">Radiologi</td> <td> :</td> <td><?php echo rp($total_radiologi);?> </tr>
