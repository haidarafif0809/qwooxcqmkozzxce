...
keterangan,
total_selisih,	
user FROM stok_opname WHERE tanggal >= '$dari_tanggal' AND tanggal <= '$sampai_tanggal' order by tanggal asc");
...
<h3><b><center> Data Stok Opname Dari Tanggal <?php echo $dari_tanggal; ?> s/d <?php echo $sampai_tanggal; ?> </center></b></h3><hr>
...
$pilih_akses_stok_opname = $db->query("SELECT stok_opname_tambah ,stok_opname_edit,
...
<form class="form-inline" action="show_filter_stok_opname.php"  method="get" role="form">
					...
					<button type="submit" name="submit" id="submit_filter_1" class="btn btn-primary" ><i class="fa fa-eye"> </i> Lihat Faktur </button>
...
<form class="form-inline" action="show_filter_stok_opname_detail.php" method="get" role="form">
					...
					<button type="submit" name="submit" id="submit_filter_2" class="btn btn-primary" ><i class="fa fa-eye"> </i> Lihat Detail </button>
