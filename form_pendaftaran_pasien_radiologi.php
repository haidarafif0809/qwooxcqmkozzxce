...
<div class="container">
	...
	<h3> FORM TAMBAH PASIEN RADIOLOGI</h3>

  <hr>
<div class="card card-block">
  

<form role="form" action="proses_tambah_pasien_radiologi.php" method="POST">
...
<div class="form-group">
    ...
    <input style="height: 20px" type="text" class="form-control" id="nama_suamiortu" name="nama_suamiortu" autocomplete="off" required="">
</div>
...
<button type="submit" class="btn btn-info"><i class='fa fa-send'></i> Tambah</button>
