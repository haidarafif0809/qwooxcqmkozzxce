 ...
 <script type="text/javascript" language="javascript" >
      $(document).ready(function() {
        var dataTable = $('#table_rawat_inap').DataTable( {
          ...
          "serverSide": true,
          "ajax":{
            url :"proses_table_ri_pulang.php", // json datasource
...
<li class="nav-item"><a class="nav-link" href='rawat_inap.php' data-placement='top' >Daftar Pasien <u>R</u>awat Inap</a></li>
        ...
        <li class="nav-item"><a class="nav-link active" href='daftar_pasien_rawat_inap_pulang.php' data-placement='top' title='Klik untuk melihat pasien sudah pulang dari rawat inap.'> Pasien Rawat Inap Pulang </a></li>
</ul>
