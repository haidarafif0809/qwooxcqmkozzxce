...
<div id="modal-selesai" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-footer">
        <a href="selesai_rj.php?no_reg=<?php echo $no_reg;?>&id=<?php echo $id;?>" class="btn btn-success" id="yesss" >Yes</a>
...
<!-- AKHIR MODAL untuk tambah Tindakan -->
 ...
 <div class="container">
   <h3>INPUT TINDAKAN RAWAT INAP</h3><hr>

 <!-- menu rekam medik -->
<ul class="nav nav-tabs md-pills pills-ins" role="tablist">

  <li class="nav-item"><a class="nav-link" href='rekam_medik_ranap.php'> Pencarian Rekam Medik </a></li>
  <li class="nav-item"><a class="nav-link" href="input_rekam_medik_ranap.php?no_reg=<?php echo $no_reg;?>&tgl=<?php echo $tgl;?>&id=<?php echo $id;?>&jam=<?php echo $jam;?>">Data Pemeriksaan</a></li>
  <li class="nav-item"><a class="nav-link " href="obat_rawat_inap.php?reg=<?php echo $no_reg; ?>&tgl=<?php echo $tgl;?>&id=<?php echo $id;?>&jam=<?php echo $jam;?>">Obat-Obatan</a></li>
  <li class="nav-item"><a class="nav-link active" href="tindakan_rawat_inap.php?reg=<?php echo $no_reg; ?>&tgl=<?php echo $tgl;?>&id=<?php echo $id;?>&jam=<?php echo $jam;?>">Tindakan</a></li>
...
<div class="form-group">
     <label for="penjamin">Petugas Dokter:</label><br>
     <select type="text" class="form-control" id="dokter" placeholder="Isi Perawat" autocomplete="off">
...
<option value="">SILAKAN PILIH</option>
 <?php 
    ...
    <input style="height: 15px;" type="hidden" class="form-control" id="nama_produk" name="nama_produk" style="width:150px" placeholder="Kode Produk" >
...
$.post("cek_kode_barang_tbs_ranap.php",{kode_barang:kode,no_reg:no_reg},function(data){

               if(data == 1){
                var r = confirm("Anda Tidak Bisa Menambahkan Obat-Obatan Yang Sudah Ada, Apakah anda akan terus melakukan nya!");
