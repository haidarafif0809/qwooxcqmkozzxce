...
$kontras = angkadoang($_POST['kontras']);
    ...
    $perintah = $db->prepare("INSERT INTO pemeriksaan_radiologi (kode_pemeriksaan,nama_pemeriksaan,harga_1,no_urut,kontras) VALUES (?,?,?,?,?)");

    $perintah->bind_param("ssiii",
        $kode,$nama,$harga_1,$no_urut,$kontras);
