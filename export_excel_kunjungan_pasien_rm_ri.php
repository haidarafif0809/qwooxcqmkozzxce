...
header("Content-Disposition: attachment; filename=data_kunjungan_pasien_ri_berdasarkan_rm.xls");
...
$take_rm = $db->query("SELECT no_rm,no_reg,nama_pasien,jenis_kelamin,umur_pasien,alamat_pasien,penjamin,hp_pasien,tanggal FROM registrasi WHERE no_rm = '$no_rm' AND jenis_pasien = 'Rawat Inap'");
