...
<ul class="nav nav-tabs yellow darken-4" role="tablist">
        ...
        <li class="nav-item"><a class="nav-link active" href='pasien_registrasi_rj_belum_selesai.php' >Pasien Belum Selesai Pembayaran </a></li>
</ul>
<br><br>
...
<!-- DATATABLE AJAX -->
    <script type="text/javascript" language="javascript" >
      $(document).ready(function() {
        var dataTable = $('#table_reg').DataTable( {
          "processing": true,
          "serverSide": true,
          "ajax":{
            url :"datatable_registrasi_rj_blm_selesai.php", // json datasource
            type: "post",  // method  , by default get
            error: function(){  // error handling
              $(".employee-grid-error").html("");
              $("#table_reg").append('<tbody class="employee-grid-error"><tr><th colspan="3">No data found in the server</th></tr></tbody>');
