...
<div class="row">
<div class="col-sm-4">
				<button type="button" class="btn btn-primary" id="per_konsumen" style="width:98%;" align="left">Rekap Periode /Penjamin </button> 
</div>	
<div class="col-sm-4">
...
<form class="form-inline" role="form">
			...
			<div class="form-group"> 
 				<select name="penjamin" id="penjamin" class="form-control chosen" required="" >
...
<script type="text/javascript">
    ...
    $("#btn-download-true").show();
     $("#cetak_true").attr("href", "cetak_laporan_penjualan_piutang_konsumen.php?dari_tanggal="+dari_tanggal+"&sampai_tanggal="+sampai_tanggal+"&penjamin="+penjamin+"");
	 $("#btn-download-true").attr("href", "download_lap_penjualan_piutang_konsumen.php?dari_tanggal="+dari_tanggal+"&sampai_tanggal="+sampai_tanggal+"&penjamin="+penjamin+"");
	$("#cetak_non").hide();
