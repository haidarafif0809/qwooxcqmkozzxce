...
<table>
 ...
 <table id="tableuser" class="table table-bordered table-sm">
      ...
      <th style="background-color: #4CAF50; color: white;"> Piutang </th>
          ...
          $perintah009 = $db->query("SELECT id,tanggal,tanggal_jt, DATEDIFF(DATE(NOW()), tanggal) AS usia_piutang ,no_faktur,kode_pelanggan,total,jam,penjamin,status,potongan,tax,sisa,kredit FROM penjualan WHERE tanggal >= '$dari_tanggal' AND tanggal <= '$sampai_tanggal' AND kredit != 0 ");
