...
<div class="col-xs-2 form-group">
    <label> Jam </label><br>
  <input style="height: 20px;" name="jam" type="text" style="height:15px;" id="jam" class="form-control jam_cari" value="<?php echo $jam; ?>" required="">
</div>
...
<?php endif ?>
                ...
                $perintah = $db->query("SELECT tp.no_faktur,tp.id,tp.kode_barang,tp.satuan,tp.nama_barang,tp.jumlah_barang,tp.harga,tp.subtotal,tp.potongan,tp.tax,tp.jam,tp.tipe_barang,s.nama FROM tbs_penjualan tp LEFT JOIN satuan s ON tp.satuan = s.id WHERE tp.no_faktur = '$no_faktur' ORDER BY tp.id DESC ");
          ...
          <div class="row">
               ...
               <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                   ...
                   <input type="text" name="biaya_admin" id="biaya_admin" style="height:15px;font-size:15px"  style="height:15px;font-size:15px" class="form-control" autocomplete="off" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" value="<?php echo rp($biaya_adm); ?>" >
                </div>
...
<div class="row">
        ...
        else
        {
         ...
         $total_akhir1 = $hitung_total + round($hitung_tax) + $biaya_adm;
          ...
          <input style="height:15px;font-size:15px;display: none;" type="text" name="tax" id="tax" value="<?php echo round($pajak); ?>"  class="form-control"  autocomplete="off" >
...
<script type="text/javascript">
  ...
  $(document).on('click','#btnRefreshsubtotal',function(e){
    ...
    var no_faktur = $("#no_faktur").val()
      ...
      $.post("proses_refresh_subtotal_edit_apotek.php",{no_faktur:no_faktur},function(data){
...
// jika dipilih, nim akan masuk ke input dan modal di tutup
  ...
  document.getElementById("harga_penjamin").value = $(this).attr('harga');
...
if (ppn == 'Exclude') {
 ...
 $.post("proses_tbs_edit_apotek.php",{no_faktur:no_faktur,kode_barang:kode_barang,nama_barang:nama_barang,jumlah_barang:jumlah_barang,harga:harga,potongan:potongan,satuan:satuan,tipe_barang:ber_stok,no_rm:no_rm,apoteker:apoteker,penjamin:penjamin,tax:tax,hargaa:hargaa, id_kasir:id_kasir,ppn:ppn},function(data){ 
  ...
  $.post("proses_tbs_edit_apotek.php",{no_faktur:no_faktur,kode_barang:kode_barang,nama_barang:nama_barang,jumlah_barang:jumlah_barang,harga:harga,potongan:potongan,tax:tax,satuan:satuan,tipe_barang:ber_stok,no_rm:no_rm,apoteker:apoteker,penjamin:penjamin,hargaa:hargaa, id_kasir:id_kasir,ppn:ppn},function(data){ 
...
alert("Anda Belum Melakukan Pemesanan");    
 ...
 $.post("proses_bayar_jual_edit_apotek.php",{id_kasir:id_kasir,no_faktur:no_faktur,biaya_admin:biaya_admin,total2:total2,sisa_pembayaran:sisa_pembayaran,kredit:kredit,kode_pelanggan:kode_pelanggan,tanggal_jt:tanggal_jt,total:total,potongan:potongan,potongan_persen:potongan_persen,cara_bayar:cara_bayar,pembayaran:pembayaran,sisa:sisa,sisa_kredit:sisa_kredit,total_hpp:total_hpp,harga:harga,kode_gudang:kode_gudang,keterangan:keterangan,ber_stok:ber_stok,ppn_input:ppn_input,apoteker:apoteker,no_resep_dokter:no_resep_dokter,resep_dokter:resep_dokter,penjamin:penjamin,tanggal:tanggal,jam:jam},function(info) {
 ...
 if (no_resep_dokter == "")
  ...
  if (data == 1) {
       ...
       $.post("proses_bayar_jual_edit_apotek.php",{id_kasir:id_kasir,no_faktur:no_faktur,biaya_admin:biaya_admin,total2:total2,sisa_pembayaran:sisa_pembayaran,kredit:kredit,kode_pelanggan:kode_pelanggan,tanggal_jt:tanggal_jt,total:total,potongan:potongan,potongan_persen:potongan_persen,cara_bayar:cara_bayar,pembayaran:pembayaran,sisa:sisa,sisa_kredit:sisa_kredit,total_hpp:total_hpp,kode_gudang:kode_gudang,keterangan:keterangan,ber_stok:ber_stok,ppn_input:ppn_input,apoteker:apoteker,no_resep_dokter:no_resep_dokter,resep_dokter:resep_dokter,penjamin:penjamin,tanggal:tanggal,jam:jam},function(info){
...
<script type="text/javascript">
  ...
  $("#kode_barang").change(function(){
    ...
    if (level_harga == "harga_1") {
        ...
        $('#harga_penjamin').val(harga_jual2);
        ...
        $('#harga_penjamin').val(harga_jual3);
        $('#kolom_cek_harga').val('1');
        }
    else if (level_harga == "harga_4") {
        ...
        $('#harga_penjamin').val(harga_jual4);
        $('#kolom_cek_harga').val('1');
        }
    else if (level_harga == "harga_5") {
        ...
        $('#harga_penjamin').val(harga_jual5);
        $('#kolom_cek_harga').val('1');
        }
    else if (level_harga == "harga_6") {
        ...
        $('#harga_penjamin').val(harga_jual6);
        $('#kolom_cek_harga').val('1');
        }
    else if (level_harga == "harga_7") {
        ...
        $('#harga_penjamin').val(harga_jual7);
        $('#kolom_cek_harga').val('1');
        }
...
<script type="text/javascript">
    ...
    // cek ppn exclude 
    $.get("cek_ppn_edit_apotek.php",{no_faktur:no_faktur},function(data){
      if (data == 1) {
          $("#ppn").val('Exclude');
     $("#ppn").attr("disabled", true);
      }
