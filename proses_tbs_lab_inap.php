...
$query0 = $db->query("SELECT * FROM tbs_penjualan WHERE kode_barang = '$kode' AND session_id = '$session_id' AND no_reg = '$no_reg' AND lab_ke_berapa = '$pemeriksa_keberapa'");
        ...
        // STARETTO HARGA BELI 1
...

          {
                  ...
                  $xml->bind_param("iiisss",
                      $jumlah, $subtotal, $potongan_tampil, $kode, $session_id,$no_reg);
          ...
          $query6 = "INSERT INTO tbs_penjualan (session_id,kode_barang,nama_barang,jumlah_barang,harga,subtotal,tipe_barang,potongan,tax,tanggal,jam,lab,no_reg,lab_ke_berapa) VALUES 
          ('$session_id','$kode','$nama','$jumlah','$hargaa','$subtotal','$tipe','$potongan_tampil','$tax_persen','$tanggal_sekarang','$jam_sekarang','Laboratorium','$no_reg','$pemeriksa_keberapa')";
...
//DOKTER
    ...
    elseif ($nominal != 0) {
      ...
      $query100 = "INSERT INTO tbs_fee_produk (nama_petugas, session_id, kode_produk,nama_produk,jumlah_fee,tanggal,jam,waktu,no_rm,no_reg) VALUES ('$dokter','$session_id','$kode','$nama','$fee_nominal_produk','$tanggal_sekarang','$jam_sekarang','$waktu','$no_rm','$no_reg')";
...
//ANALIS
    ...
    elseif ($nominal != 0) {
      ...
      $query100 = "INSERT INTO tbs_fee_produk (nama_petugas, session_id, kode_produk,nama_produk,jumlah_fee,tanggal,jam,waktu,no_rm,no_reg) VALUES ('$analis','$session_id','$kode','$nama','$fee_nominal_produk','$tanggal_sekarang','$jam_sekarang','$waktu','$no_rm','$no_reg')";
              if ($db->query($query100) === TRUE) 
                {
...
<?php
  //menampilkan semua data yang ada pada tabel tbs penjualan dalam DB
                $perintah = $db->query("SELECT * FROM tbs_penjualan WHERE session_id = '$session_id' AND no_reg = '$no_reg' AND lab = 'Laboratorium' ORDER BY id DESC LIMIT 1");
