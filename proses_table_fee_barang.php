...
$sql = "SELECT b.kode_barang,b.nama_barang,b.satuan,b.harga_beli,b.stok_barang,b.harga_jual,b.kategori,b.status,b.suplier,b.id,s.nama AS nama_satuan";
...
if( !empty($requestData['search']['value']) ) {   // if there is a search parameter, $requestData['search']['value'] contains search parameter
	...
	$sql.=" OR b.harga_jual LIKE '".$requestData['search']['value']."%' ";
	$sql.=" OR b.harga_beli LIKE '".$requestData['search']['value']."%' )";
}
