...
<li class="nav-item"><a class="nav-link active" href='persediaan_filter_over.php?kategori=semua&tipe=barang'>Filter Over Stok</a></li>
...
<li class="nav-item"><a class="nav-link active" href='persediaan_filter_over.php?kategori=semua&tipe=barang_jasa'>Filter Over Stok</a></li>
...
<!--Form Filter-->
 ...
 <div class="col-sm-2">
     <div class="form-group">
     <input type="text" placeholder="Jumlah Over Stok" name="filter_limit" id="filter_limit" class="form-control" autocomplete="off" required="">
     </div>
 </div>
...
<script type="text/javascript">
        ...
        $.post("show_filter_over_barang.php", {filter_limit:filter_limit},function(info){
