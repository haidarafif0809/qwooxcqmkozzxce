...
$query = $db->query("SELECT * FROM rekam_medik WHERE id = '$id'");
...
$query2 = $db->query("SELECT nama_barang,dosis,jumlah_barang FROM detail_penjualan dp LEFT JOIN barang b ON dp.kode_barang = b.kode_barang WHERE no_reg = '$data[no_reg]' AND (dp.tipe_produk = 'Obat Obatan' OR b.tipe_barang = 'Obat Obatan') ");
...
{
$query21 = $db->query("SELECT nama_barang,dosis,jumlah_barang FROM tbs_penjualandp LEFT JOIN barang b ON dp.kode_barang = b.kode_barang WHERE no_reg = '$data[no_reg]' AND (dp.tipe_produk = 'Obat Obatan' OR b.tipe_barang = 'Obat Obatan') ");
