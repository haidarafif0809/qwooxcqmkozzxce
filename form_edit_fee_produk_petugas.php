...
<h3>FORM EDIT KOMISI PRODUK / JABATAN </h3><hr>
...
<div class="form-group">
					...
					<input type="text" style="height: 15px" name="nama_produk" id="nama_produk" placeholder="Nama Produk" class="form-control" readonly="">
					</div>

					<div class="form-group">
					<label> Kode Produk </label><br>
					<input type="text" style="height: 15px" name="kode_produk" id="kode_produk" placeholder="Kode Produk " class="form-control" readonly="" >
					</div>

<span id="prosentase">
					<div class="form-group">
					<label> Jumlah Prosentase </label><br>
					<input type="text" style="height: 15px" name="jumlah_prosentase" placeholder="Jumlah Prosentase" id="jumlah_prosentase" class="form-control" autocomplete="off">
					</div>
</span>
...
<span id="nominal">
					...
					<input type="text" style="height: 15px" name="jumlah_uang" id="jumlah_nominal" placeholder="Jumlah Nominal" class="form-control" autocomplete="off">
					</div>
</span>

					<div class="form-group">
					<label> Jabatan </label><br>
					<select type="text" name="jabatan" id="jabatan" class="form-control chosen">
...
mysqli_close($db);     
    ?>
          ...
          <button type="submit" id="tambah_fee" class="btn btn-info"> <i class='fa fa-save'> </i> Simpan</button>
          <a href="form_edit_fee_produk_petugas.php" style="display: none" type="btn" id="refresh" class="btn btn-success"> <i class='fa fa-refresh'> </i> Input Baru</a>
...
// jika dipilih, nim akan masuk ke input dan modal di tutup
...

 {
 	...
 	$.post("proses_update_fee_produk_jabatan.php",{nama_produk:nama_produk,kode_produk:kode_produk,jumlah_prosentase:jumlah_prosentase,jumlah_uang:jumlah_nominal,jabatan:jabatan},function(info){
