...
<div class="row armun">
      <div class="col-sm-8"><!--first div class="col-sm-8 "div class="row armun"-->
      ...
      <form enctype="multipart/form-data" role="form" action="form_retur_pembelian.php" method="post ">
        ...
        <div class="row 1">
          ...
          <div class="col-sm-2">
              <label> <font class='satu'> <b>Tanggal</b> </font> </label><br>
              <input style="height:3%;" type="text" value="<?php echo $ambil['tanggal']; ?>" style="height: 20px" name="tanggal" id="tanggal" placeholder="Tanggal"  class="form-control tgl" required="" >
          </div>

          <div class="col-sm-2">
              <label> <font class='satu'> <b>No Faktur </b> </font></label><br>
              <input style="height:3%;" type="text" name="no_faktur_retur" style="height: 20px" id="nomorfaktur" class="form-control" readonly="" value="<?php echo $no_faktur_retur; ?>" required="" >
          </div>


          <div class="col-sm-2">
              
              <label> <font class='satu'> <b>User</b> </font> </label><br>
              <!-- readonly = digunakan agar teks atau isi hanya bisa dibaca tapi tidak bisa diubah -->
              <input style="height:3%;" type="text" name="user" class="form-control" readonly="" style="height: 20px" value="<?php echo $_SESSION['user_name']; ?>" required="">
          ...
          <!-- PPN -->
             <?php if ($data_tbs > 0): ?>
                          ...
                          <div class="col-sm-2">
                          <label><font class='satu'> <b>PPN</b> </font></label><br>
                          <select style="height:5%;" name="ppn" id="ppn" class="form-control" disabled="true">
                          ...
                          <div class="col-sm-3">
                          <label><font class='satu'> <b>PPN</b> </font></label>
        ...
        <div class="row 3">
              ...
              <div class="form-group  col-sm-1">
                <input type="text" class="form-control" name="jumlah_retur" autocomplete="off" id="jumlah_retur" placeholder="Qty.">
              </div>


            <div class="form-group col-sm-2">
            <label></label>
                      <select style="width:80%;" name="satuan_konversi" id="satuan_konversi" class="form-control"  required=""  >
              ...
              <div class="form-group col-sm-2">
                <input type="text" id="tax1" name="tax1" class="form-control" autocomplete="off" value="" placeholder="Tax (%)">
              </div>

              <div class="form-group col-sm-2">
                <input type="text" class="form-control" name="potongan1" data-toggle="tooltip" data-placement="top" id="potongan1" placeholder="Disc." autocomplete="off">
              </div>
            
            <div class="col-sm-3">
                <!-- membuat tombol submit-->
              <button type="submit" id="submit_produk" class="btn btn-success"> <span class='glyphicon glyphicon-plus'> </span> Tambah (F3)</button>
            </div>    
    </div>
  ...
  </div><!--end div class="col-sm-8"div class="row armun"-->

  <div class="col-sm-4"><!--first div class="col-sm-4"div class="row armun"-->
      <div class="card card-block">
        <form action="proses_bayar_retur_beli.php" id="form_beli" method="POST"><!--tag pembuka form-->

          <div class="row 1">
                <div class="col-sm-6">
                    <label><font class='satu'> <b> Subtotal </b> </font></label><br>
          ...
          <div class="row 2">
            <div class="col-sm-6">
                <label><b> <font class='satu'>Disc. (Rp)</font> </b></label><br>
            ...
            <div class="col-sm-6">
                <label><b><font class='satu'> Dis. (%)</font> </b></label><br>
        ...
        <div class="row 4">
          <div class="col-sm-6">
            <label><b> <font class='satu'>Pembayaran (F6)</font></b></label><br>
            <b><input style="height: 20px; font-size: 25px;" type="text" name="pembayaran" id="pembayaran_pembelian" autocomplete="off" class="form-control" placeholder="Pembayaran" ></b>
          </div>

          <div class="col-sm-6">
          <label> <b><font class='satu'>Kembalian</font></b>  </label><br>
    ...
    <!-- memasukan teks pada kolom suplier, dan nomor faktur namun disembunyikan -->
          ...
          <button type="submit" id="pembayaran" class="btn btn-info"><span class='glyphicon glyphicon-ok'> </span>  Bayar (F8)</button>
          
          <a class="btn btn-info" href="form_retur_pembelian.php" id="transaksi_baru" style="display: none"> <span class="glyphicon glyphicon-repeat"></span> Transaksi Baru (CTRL+M)</a>

          <!--membuaat link pada tombol batal-->
          <a href='batal_edit_retur_pembelian.php?no_faktur_retur=<?php echo $no_faktur_retur;?>' id="batal" class='btn btn-danger'><span class='glyphicon glyphicon-remove'></span> Batal (F10) </a>

          <a href='cetak_retur_pembelian.php' id="cetak_retur" style="display: none;" class="btn btn-success" target="blank"><span class="glyphicon glyphicon-print"> </span> Cetak Retur Penjualan (CTRL+R) </a>
  ...
  </div><!--div class="col-sm-4"div class="row armun"-->
...
<!--menambahkan shorchute-->
  <script type="text/javascript"> 
    ...
    var session_id = $("#session_id").val()
        ...
        window.location.href="batal_edit_retur_pembelian.php?session_id="+session_id+"";
