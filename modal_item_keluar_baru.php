...
//total barang 2
       ...
       $cek_harga_hpp = $db->query("SELECT harga_unit FROM hpp_masuk WHERE kode_barang = '$row[kode_barang]' AND sisa != 0 ORDER BY waktu DESC LIMIT 1  ");
        $harga_kel = mysqli_fetch_array($cek_harga_hpp);
        $harga_hpp = $harga_kel['harga_unit'];
