...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	$nestedData=array();      
      ...
      $pelanggan = $db_pasien->query("SELECT nama_pelanggan FROM pelanggan WHERE kode_pelanggan = '$row[kode_pelanggan]'");
      ...
      $sum_pajak_penjualan = $db->query("SELECT SUM(tax) AS pajak FROM penjualan WHERE no_faktur = '$row[no_faktur]'");
      $cek_sum_pajak = mysqli_fetch_array($sum_pajak_penjualan);
