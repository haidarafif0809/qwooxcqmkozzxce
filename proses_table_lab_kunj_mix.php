...
$sql.=" FROM registrasi WHERE no_rm = '$no_rm' AND  tanggal >= '$dari_tanggal' AND tanggal <= '$sampai_tanggal' AND jenis_pasien = 'Rawat Jalan' ";
...
$sql.=" FROM registrasi WHERE 1=1 AND no_rm = '$no_rm' AND  tanggal >= '$dari_tanggal' AND tanggal <= '$sampai_tanggal' AND jenis_pasien = 'Rawat Jalan' ";
