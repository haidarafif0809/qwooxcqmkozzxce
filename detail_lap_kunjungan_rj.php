...
$query = $db->query("SELECT * FROM rekam_medik WHERE no_rm = '$no_rm' AND no_reg = '$no_reg'");
...
<h2><center><b>Data Laporan Pasien Rawat Jalan</b></center></h2>
...
<a href='export_lap_kunjungan_rj.php?no_rm=<?php echo $no_rm; ?>&no_reg=<?php echo $no_reg; ?>' type='submit' class='btn btn-warning btn-lg'>Download Excel</a>
