...
$query0 = $db->query("SELECT * FROM tbs_penjualan WHERE kode_barang = '$kode' AND no_reg ='$no_reg' AND tipe_barang = 'Obat Obatan'");
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$dokterpenanggungjawab','$kode','$nama','$hasil_hitung_fee_persen',
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$dokterpenanggungjawab','$kode','$nama','$hasil_hitung_fee_nominal',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$apoteker','$kode','$nama','$hasil_hitung_fee_persen_apoteker','$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$apoteker','$kode','$nama','$hasil_hitung_fee_nominal_apoteker','$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$perawat','$kode','$nama','$hasil_hitung_fee_persen_perawat','$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$perawat','$kode','$nama','$hasil_hitung_fee_nominal_perawat','$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$petugas','$kode','$nama','$hasil_hitung_fee_persen_petugas','$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$petugas','$kode','$nama','$hasil_hitung_fee_nominal_petugas','$tanggal_sekarang','$jam')";
...
$query6 = " INSERT INTO tbs_penjualan (session_id, dosis, no_reg, kode_barang, nama_barang, jumlah_barang, harga, subtotal, tipe_barang, tanggal, jam, satuan) VALUES ('$session_id', '$dosis', '$no_reg', '$kode', '$nama', '$jumlah', '$harga_1', '$subtotaljadi', '$jenis', '$tanggal_sekarang', '$jam', '$harga[satuan]')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$dokterpenanggungjawab','$kode','$nama','$hasil_hitung_fee_persen_harga2',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$dokterpenanggungjawab','$kode','$nama','$hasil_hitung_fee_nominal_harga2',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$apoteker','$kode','$nama','$hasil_hitung_fee_persen_apoteker_harga2',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$apoteker','$kode','$nama','$hasil_hitung_fee_nominal_apoteker_harga2',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$perawat','$kode','$nama','$hasil_hitung_fee_persen_perawat_harga2',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$perawat','$kode','$nama','$hasil_hitung_fee_nominal_perawat_harga2',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$petugas','$kode','$nama','$hasil_hitung_fee_persen_petugas_harga2',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$petugas','$kode','$nama','$hitung_fee_nominal_petugas_harga2',
  '$tanggal_sekarang','$jam')";
...
$query10 = "INSERT INTO tbs_penjualan (session_id, dosis, no_reg, kode_barang, nama_barang, jumlah_barang, harga, subtotal, tipe_barang, tanggal, jam, satuan) VALUES ('$session_id', '$dosis', '$no_reg', '$kode', '$nama', '$jumlah', '$harga_2', '$subtotaljadi2', '$jenis', '$tanggal_sekarang', '$jam', '$harga[satuan]')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$dokterpenanggungjawab','$kode','$nama','$hasil_hitung_fee_persen_harga3',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$dokterpenanggungjawab','$kode','$nama','$hasil_hitung_fee_nominal_harga3',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$apoteker','$kode','$nama','$hasil_hitung_fee_persen_apoteker_harga3',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$apoteker','$kode','$nama','$hasil_hitung_fee_nominal_apoteker_harga3',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$perawat','$kode','$nama','$hasil_hitung_fee_persen_perawat_harga3',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$perawat','$kode','$nama','$hasil_hitung_fee_nominal_perawat_harga3',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$petugas','$kode','$nama','$hasil_hitung_fee_persen_petugas_harga3',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$petugas','$kode','$nama','$hitung_fee_nominal_petugas_harga3','$tanggal_sekarang','$jam')";
...
$query14 = "INSERT INTO tbs_penjualan (session_id,  dosis, no_reg, kode_barang, nama_barang, jumlah_barang, harga, subtotal, tipe_barang, tanggal, jam, satuan) VALUES ('$session_id', '$dosis', '$no_reg', '$kode', '$nama', '$jumlah', '$harga_3', '$subtotaljadi3', '$jenis', '$tanggal_sekarang', '$jam', '$harga[satuan]')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$dokterpenanggungjawab','$kode','$nama','$hasil_hitung_fee_persen_harga4',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$dokterpenanggungjawab','$kode','$nama','$hasil_hitung_fee_nominal_harga4',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$apoteker','$kode','$nama','$hasil_hitung_fee_persen_apoteker_harga4',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$apoteker','$kode','$nama','$hasil_hitung_fee_nominal_apoteker_harga4',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$perawat','$kode','$nama','$hasil_hitung_fee_persen_perawat_harga4',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$perawat','$kode','$nama','$hasil_hitung_fee_nominal_perawat_harga4',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$petugas','$kode','$nama','$hasil_hitung_fee_persen_petugas_harga4',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$petugas','$kode','$nama','$hitung_fee_nominal_petugas_harga4',
  '$tanggal_sekarang','$jam')";
...
$query10 = "INSERT INTO tbs_penjualan (session_id,  dosis, no_reg, kode_barang, nama_barang,  jumlah_barang, harga, subtotal, tipe_barang, tanggal, jam) VALUES ('$session_id', '$dosis', '$no_reg', '$kode', '$nama', '$jumlah', '$harga_4', '$subtotaljadi4', '$jenis', '$tanggal_sekarang', '$jam', '$harga[satuan]')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$dokterpenanggungjawab','$kode','$nama','$hasil_hitung_fee_persen_harga5',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$dokterpenanggungjawab','$kode','$nama','$hasil_hitung_fee_nominal_harga5',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$apoteker','$kode','$nama','$hasil_hitung_fee_persen_apoteker_harga5',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$apoteker','$kode','$nama','$hasil_hitung_fee_nominal_apoteker_harga5',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$perawat','$kode','$nama','$hasil_hitung_fee_persen_perawat_harga5',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$perawat','$kode','$nama','$hasil_hitung_fee_nominal_perawat_harga5',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$petugas','$kode','$nama','$hasil_hitung_fee_persen_petugas_harga5',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$petugas','$kode','$nama','$hitung_fee_nominal_petugas_harga5',
  '$tanggal_sekarang','$jam')";
...
$query10 = "INSERT INTO tbs_penjualan (session_id, dosis,no_reg,kode_barang,nama_barang,
  jumlah_barang,harga,subtotal,tipe_barang,tanggal,jam, satuan) VALUES ('$session_id','$dosis','$no_reg','$kode','$nama','$jumlah','$harga_5','$subtotaljadi5','$jenis', '$tanggal_sekarang','$jam', '$harga[satuan]')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$dokterpenanggungjawab','$kode','$nama','$hasil_hitung_fee_persen_harga6',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$dokterpenanggungjawab','$kode','$nama','$hasil_hitung_fee_nominal_harga6',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$apoteker','$kode','$nama','$hasil_hitung_fee_persen_apoteker_harga6',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$apoteker','$kode','$nama','$hasil_hitung_fee_nominal_apoteker_harga6',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$perawat','$kode','$nama','$hasil_hitung_fee_persen_perawat_harga6',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$perawat','$kode','$nama','$hasil_hitung_fee_nominal_perawat_harga6',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$petugas','$kode','$nama','$hasil_hitung_fee_persen_petugas_harga6',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$petugas','$kode','$nama','$hitung_fee_nominal_petugas_harga6',
  '$tanggal_sekarang','$jam')";
...
$query10 = "INSERT INTO tbs_penjualan (session_id, dosis,no_reg,kode_barang,nama_barang,
  jumlah_barang,harga,subtotal,tipe_barang,tanggal,jam, satuan) VALUES ('$session_id','$dosis','$no_reg','$kode','$nama','$jumlah','$harga_6','$subtotaljadi6','$jenis', '$tanggal_sekarang','$jam', '$harga[satuan]')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$dokterpenanggungjawab','$kode','$nama','$hasil_hitung_fee_persen_harga7',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$dokterpenanggungjawab','$kode','$nama','$hasil_hitung_fee_nominal_harga7',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$apoteker','$kode','$nama','$hasil_hitung_fee_persen_apoteker_harga7',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$apoteker','$kode','$nama','$hasil_hitung_fee_nominal_apoteker_harga7',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$perawat','$kode','$nama','$hasil_hitung_fee_persen_perawat_harga7',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$perawat','$kode','$nama','$hasil_hitung_fee_nominal_perawat_harga7',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$petugas','$kode','$nama','$hasil_hitung_fee_persen_petugas_harga7',
  '$tanggal_sekarang','$jam')";
...
(no_reg,no_rm,nama_petugas,kode_produk,nama_produk,jumlah_fee,tanggal,jam) VALUES 
('$no_reg','$no_rm','$petugas','$kode','$nama','$hitung_fee_nominal_petugas_harga7',
  '$tanggal_sekarang','$jam')";
...
$query10 = "INSERT INTO tbs_penjualan (session_id, dosis,no_reg,kode_barang,nama_barang,
  jumlah_barang,harga,subtotal,tipe_barang,tanggal,jam, satuan) VALUES ('$session_id','$dosis','$no_reg','$kode','$nama','$jumlah','$harga_7','$subtotaljadi7','$jenis', '$tanggal_sekarang','$jam', '$harga[satuan]')";
...
$query5 = $db->query("SELECT * FROM tbs_penjualan WHERE no_reg ='$no_reg ' AND tipe_barang = 'Obat Obatan' ORDER BY id DESC LIMIT 1 ");


$ss = $db->query("SELECT * FROM detail_penjualan WHERE no_reg ='$no_reg' AND tipe_produk = 'Obat Obatan' ORDER BY id DESC LIMIT 1 ");

$asa = mysqli_num_rows($ss);
if ($asa > 0)
      {
        $delete2 = $db->query("DELETE FROM tbs_penjualan WHERE no_reg = '$no_reg' ");
  $data00 = mysqli_fetch_array($ss);

      echo 
      "<tr class='tr-id-".$data00['id']."'>
      <td>". $data00['no_reg']."</td>
...
$data01 = mysqli_fetch_array($query5);
