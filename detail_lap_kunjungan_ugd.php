...
$query = $db->query("SELECT * FROM rekam_medik_ugd WHERE no_rm = '$no_rm' AND no_reg = '$no_reg'");
...
<h2><center><b>Data Laporan Pasien UGD</b></center></h2>
...
<br>
 ...
 <b>
  ...
  Tanggal / Jam : <?php echo $data['tanggal']; ?> /  <?php echo $data['jam']; ?>
  </b>
</h4>
<br>
...
<a href='export_lap_kunjungan_ugd.php?no_rm=<?php echo $no_rm; ?>&no_reg=<?php echo $no_reg; ?>' type='submit' class='btn btn-warning btn-lg'>Download Excel</a>
