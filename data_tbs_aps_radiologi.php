...
while($row = mysqli_fetch_array($query)) {  // preparing an array
  $nestedData = array(); 
      ...
      $nestedData[] = "<button class='btn btn-danger btn-sm btn-hapus-tbs-radiologi' id='hapus-tbs-". $row['id'] ."' data-id='". $row['id'] ."' data-kode='". $row['kode_barang'] ."' data-barang='". $row['nama_barang'] ."' data-subtotal='". $row['subtotal'] ."'>Hapus</button>";
